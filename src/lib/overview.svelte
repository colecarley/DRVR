...
<div class="grid grid-cols-{cols} gap-6 w-full p-12" id="slide-container">
    {#each slides as s}
        <button onclick={() => onchoose(s)}>
            <SlideCard slide={s} />
        </button>
    {/each}
</div>
